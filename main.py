# Code from https://github.com/yanivnik/sinfusion-code
...
from gen_model.diffusion.conditional_diffusion import ConditionalDiffusion
from gen_model.diffusion.diffusion import Diffusion
from gen_model.model.nextnet import NextNet
